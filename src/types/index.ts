...
export const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      "Unlimited AI photo verification & Gardener's Notes",
  ...
  },
  {
    ...
    features: [
      ...
      "1 Streak Shield per billing cycle (protects 1 missed week)",
      "5 AI Coach uses per week (UTC) — separate from Gardener's Notes",
      "Unlimited AI photo verification & Gardener's Notes",
      "Goal Gallery (history, proof photos, streaks)",
      "Pro achievements & badges",
      "Priority support",
    ],
    stripePriceIdMonthly: "price_1TdC1FRCYZcTM6h48Z2BzTgF",
    stripePriceIdYearly: "price_1TdC1pRCYZcTM6h4nNADqUU6",
  },
  {
    id: "premium",
    name: "Premium",
    ...
    features: [
      ...
      "Strict AI verification option with richer feedback",
      "1 Streak Shield per billing cycle (protects 1 missed week)",
      "20 AI Coach uses per week (UTC) — separate from Gardener's Notes",
      "Unlimited AI photo verification & Gardener's Notes",
      "Unlimited Goal Gallery with weekly photo collages",
      "Share weekly collages & progress as images",
      "Exclusive achievements & rewards",
      "Priority & dedicated support",
    ],
    stripePriceIdMonthly: "price_1TdC2hRCYZcTM6h4MSAsOXvi",
    stripePriceIdYearly: "price_1TdC2hRCYZcTM6h4bOLrJ505",
  },
];
